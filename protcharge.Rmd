...
Use the equation to calculate the fraction in the base or acid form (whichever is charged) and then multiply this fraction by the charge. If you need help with this equation see XXXX.
